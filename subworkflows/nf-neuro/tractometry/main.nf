...
main:
    ...
    mean_std_lesions_tsv            = BUNDLE_STATS.out.mean_lesions_tsv ?: Channel.empty()
    mean_std_per_point_lesions_tsv  = BUNDLE_STATS.out.mean_per_point_lesions_tsv ?: Channel.empty()
